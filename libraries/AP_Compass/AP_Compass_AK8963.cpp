...
bool AP_Compass_AK8963::_self_test()
{
    ...
    /* AK8963.pdf p.19 */
    _register_write(AK8963_CNTL1, AK8963_POWERDOWN_MODE | _magnetometer_adc_resolution); /* Register value to continuous measurement in 14-bit */
    _register_write(AK8963_ASTC, AK8983_SELFTEST_MAGNETIC_FIELD_ON); /* Turn the internal magnetic field on */
    _register_write(AK8963_CNTL1, AK8963_SELFTEST_MODE | _magnetometer_adc_resolution); /* Register value to self-test mode in 14-bit */
    ...
    debug("AK8963's SELF-TEST STARTED\n");
    ...
    debug("AK8963's SELF-TEST ENDED: %f %f %f\n", hx, hy, hz);

    _register_write(AK8963_ASTC, 0x0); /* Turn the internal magnetic field off */
    _register_write(AK8963_CNTL1, AK8963_POWERDOWN_MODE | _magnetometer_adc_resolution); /* Register value to continuous measurement in 14-bit */
...
bool AP_Compass_AK8963::init()
{
    ...
    _register_write(AK8963_CNTL1, AK8963_CONTINUOUS_MODE2 | _magnetometer_adc_resolution);/* Register value to continuous measurement in 14bit */
...
bool AP_Compass_AK8963::read()
{
    ...
    _compass._field[_compass_instance] += _compass._offset[_compass_instance].get();
